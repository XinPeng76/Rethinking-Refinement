...
def sample_from_model(model, x_0):
    ...
    return fake_image
# =====================================================
def generate_samples_vae(model, vae, parallel, savedir, step, net_="normal"):
    model.eval()
    ...
    B = 16
    x0 = torch.randn(B, 4, 32, 32, device=device)
...
flags.DEFINE_string("output_dir", "./resultsz/0.1", help="output directory")
...
def train(argv):
    ...
    # VAE (frozen)
    # ---------------------
    dataset = FFHQLatentDataset("./fid_samples/ffhq256_fm_z")
