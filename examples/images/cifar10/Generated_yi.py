...
flags.DEFINE_string("save_path", "./generated_images_i.npz", help="Path to save the generated npz file")
...
PATH2 = f"{FLAGS.input_dir}/iotcfm/otcfm_cifar10_weights_step_400000.pt"
...
def gen_batch(batch_size):
    ...
    with torch.no_grad():
        ...
        x0 = traj[-1]
        x0 = x0 
        traj = node2.trajectory(x0, t_span=t_span2)
