...
flags.DEFINE_string("save_path", "./generated_images_d.npz", help="Path to save the generated npz file")
...
PATH2 = f"{FLAGS.input_dir}/dotcfm/otcfm_cifar10_weights_step_400000.pt"
