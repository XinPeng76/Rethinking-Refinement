...
flags.DEFINE_string("save_path", "./generated_images_y2.npz", help="Path to save the generated npz file")
...
# Load the model
PATH = f"{FLAGS.input_dir}/otcfm_cifar10_weights_step_400000.pt"
PATH2 = f"{FLAGS.input_dir}/xotcfm/otcfm_cifar10_weights_step_400000.pt"
...
def gen_batch(batch_size):
    ...
    with torch.no_grad():
        ...
        if FLAGS.integration_method == "euler":
            ...
            #t_span2 = torch.linspace(0, 1, 2, device=device)
            traj = odeint(
                vf1, x, t_span, rtol=FLAGS.tol, atol=FLAGS.tol, method=FLAGS.integration_method
            )
        traj = node2.trajectory(traj[-1], t_span=t_span2)
